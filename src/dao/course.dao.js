...
var CourseDao = /** @class */ (function () {
    function CourseDao() {
        ...
        this.getAllCourses = function (getCourseReq) { return __awaiter(_this, void 0, void 0, function () {
            var query, skip, limit, courses, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        skip = +getCourseReq.skip;
                        limit = +getCourseReq.limit;
                        console.log(query);
                        return [4 /*yield*/, course_model_1.default.find(query).skip(skip).limit(limit)];
                    case 1:
                        courses = _a.sent();
        ...
        this.dropCourse = function (courseCode) { return __awaiter(_this, void 0, void 0, function () {
            var res, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, course_model_1.default.deleteOne({ code: courseCode })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                    case 2:
